...
<div class="panel admin-panel">
  <div class="panel-head"><strong><span class="icon-key"></span>学生信息上传</strong></div>
  <div class="body-content">
    <form method="post" class="form-x" action="people_add1"  enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="mpass" name="number2" size="50" placeholder="请输入学号" data-validate="required:请输入学号" />       
        </div>
      </div>
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="password" class="input w50" id="mpass" name="password" size="50" placeholder="请输入登录密码" data-validate="required:请输入登录密码" />       
        </div>
      </div>
      <div class="form-group">
        <div class="label">
       ...
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="mpass" name="address" size="50" placeholder="请输入联系地址" data-validate="required:请输入联系地址" />       
        </div>
      </div>
