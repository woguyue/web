 ...
 */
@WebServlet("/people_add1")
public class people_add1 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            People p = new People();
            p.setName(name.getString("utf-8"));p.setSex(sex.getString("utf-8"));
            p.setAddress(address.getString("utf-8"));p.setPhone(phone.getString("utf-8"));      
            
            int ran = (int) (Math.random()*(100000000-1)+1); 
            p.setNumber(String.valueOf(ran));
            ...
            FaceAdd.add("zzz",p.getNumber(),imgStr);
        ...
        RequestDispatcher dispacher = request.getRequestDispatcher("people_add1.jsp?flag=1");
